...
var G__32602 = devtools.prefs.pref(v);
v = G__32602;
continue;
} else {
return v;
...
}catch (e32540){var _e__31100__auto__ = e32540;
return false;
}})();
...
}catch (e32544){var _e__31100__auto__ = e32544;
return false;
}})();
...
}catch (e32546){var _e__31100__auto__ = e32546;
return false;
}}
}
});
...
var vec__32574 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32574,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32574,(1),null);
...
return cljs.core.some((function (p1__32579_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__32579_SHARP_);
}),template);
});
