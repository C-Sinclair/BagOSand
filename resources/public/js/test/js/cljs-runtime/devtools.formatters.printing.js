...
var len__4789__auto___32702 = arguments.length;
var i__4790__auto___32703 = (0);
while(true){
if((i__4790__auto___32703 < len__4789__auto___32702)){
args__4795__auto__.push((arguments[i__4790__auto___32703]));

var G__32704 = (i__4790__auto___32703 + (1));
i__4790__auto___32703 = G__32704;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32606){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32607,G__32608,seq32606__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32636_SHARP_){
return (!((cljs.core.meta(p1__32636_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32663__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32667){var _e__31100__auto__ = e32667;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e32669){var _e__31100__auto__ = e32669;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32675 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32676 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32676);

try{var map__32677 = opts;
var map__32677__$1 = (((((!((map__32677 == null))))?(((((map__32677.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32677.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__32677):map__32677);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32677__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32675);
}});
...
var temp__5733__auto___32749 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___32749)){
var managed_print_level_32750 = temp__5733__auto___32749;
var _STAR_print_level_STAR__orig_val__32684_32751 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32685_32752 = managed_print_level_32750;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32685_32752);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__32682_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32682_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32684_32751);
}} else {
job_fn();
}
