...
var G__35404 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__35404;
continue;
} else {
return ch;
...
var vec__35396 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35396,(0),null);
return (match === s);
});
...
args__4795__auto__.push((arguments[i__4790__auto___35417]));

var G__35420 = (i__4790__auto___35417 + (1));
i__4790__auto___35417 = G__35420;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq35401){
...
return (function() { 
var G__35421__delegate = function (rdr,_){
...
var G__35421 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__35424__i = 0, G__35424__a = new Array(arguments.length -  1);
while (G__35424__i < G__35424__a.length) {G__35424__a[G__35424__i] = arguments[G__35424__i + 1]; ++G__35424__i;}
  _ = new cljs.core.IndexedSeq(G__35424__a,0,null);
} 
return G__35421__delegate.call(this,rdr,_);};
G__35421.cljs$lang$maxFixedArity = 1;
G__35421.cljs$lang$applyTo = (function (arglist__35425){
var rdr = cljs.core.first(arglist__35425);
var _ = cljs.core.rest(arglist__35425);
return G__35421__delegate(rdr,_);
});
